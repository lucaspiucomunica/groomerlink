...
// GET - Buscar cartão para edição por username (com verificação de email)
...
// PUT - Atualizar cartão existente por username
export async function PUT(
  ...
  try {
    ...
    // Validar novo username se foi alterado
    if (newUsername && newUsername !== username) {
      ...
      if (usernameExiste && usernameExiste.id !== cartaoExistente.id) {
        return NextResponse.json(
